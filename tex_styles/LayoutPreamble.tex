...
% \documentclass[oneside, \pointsize]{amsbook} % 2021 C.A.R modified
...
\usepackage[numbers,square,sort,compress]{natbib} % C.A.R. used natbib instead
...
%% -- Since I've deleted amsbook, then all the maths pacakges are gone
%% adding them here now
